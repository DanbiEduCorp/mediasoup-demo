...
export ANNOUNCED_MIN_PORT=${ANNOUNCED_MIN_PORT:="44444"}
export ANNOUNCED_MAX_PORT=${ANNOUNCED_MAX_PORT:="44445"}
...
docker run \
	...
	-p ${ANNOUNCED_MIN_PORT}-${ANNOUNCED_MAX_PORT}:${ANNOUNCED_MIN_PORT}-${ANNOUNCED_MAX_PORT}/udp \
  -p ${ANNOUNCED_MIN_PORT}-${ANNOUNCED_MAX_PORT}:${ANNOUNCED_MIN_PORT}-${ANNOUNCED_MAX_PORT}/tcp \
	-v ${PWD}:/storage \
	...
	-e ANNOUNCED_MIN_PORT \
	-e ANNOUNCED_MAX_PORT \
